...
metrics = ("ami", "modularity") # Valid metrics: "ami", "ari", "nmi", "ch"
...
dataset_names = [name for name in os.listdir("DSBM_datasets") if os.path.isdir(os.path.join("DSBM_datasets", name))]
method_specs = [
    #("spectral", "SC-UN"),
    ("spectral", "SC-N"),
    #("dsc", "DSC+"),
