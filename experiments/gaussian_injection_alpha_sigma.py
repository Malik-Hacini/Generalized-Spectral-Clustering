...
dataset_names = []
print("Generating Gaussian injection graph datasets...")

for sigma_injection in sigma_injection_values:
        ...
        for seed in seeds:
            ...
            if not graph_file.exists():
                injected_graph, labels, _ = generate_gaussian_injection(
                    ...
                    sigma_injection=float(sigma_injection),  # type: ignore[arg-type]
                    alpha=float(alpha),
                    bandwidth=bandwidth,
                    seed=int(seed),
                )
